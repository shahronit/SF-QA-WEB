...
const QATestArtifacts = lazy(() => import('./pages/QATestArtifacts'))
      ...
      <JiraProvider>
        <TestManagementProvider>
          ...
          <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
            ...
            <Route path="qa-test-artifacts" element={<QATestArtifacts />} />
            {/* Backwards-compatible redirect for the previous URL — kept
                so existing bookmarks and links land on the renamed page
                instead of a 404. Safe to delete once we're confident no
                one is still using the old path. */}
            <Route path="quick-pack" element={<Navigate to="/qa-test-artifacts" replace />} />
