...
export const AGENT_META = {
  ...
  test_strategy: {
    ...
    hints: [
      'Tip: link a Requirements run to seed the strategy with real risks.',
      'IEEE 829 sections are produced — use the Markdown export for sign-off docs.',
    ],
    visual: 'sparkline',
  },
  test_plan: {
    label: 'Test Plan Documentation',
    phaseId: 'P2',
    icon: '📋',
    gradient: 'from-cyan-500 to-teal-500',
    accentText: 'text-cyan-600',
    hints: [
      'Tip: chain a Test Strategy result for a richer Approach & Methodology section.',
