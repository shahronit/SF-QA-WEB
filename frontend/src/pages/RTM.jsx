    ...
    <div>
      ...
      <AgentForm
        ...
        fields={[
          ...
          { key: 'test_cases', label: 'Test cases', type: 'textarea', rows: 6, placeholder: 'Paste test cases here. e.g.\nTC_001: Verify successful login with valid credentials -> REQ_001\nTC_002: Verify invalid password shows error -> REQ_001' },
          { key: 'defects', label: 'Defects (optional)', type: 'textarea', rows: 4, placeholder: 'Paste defect list. e.g.\nDEF_001: Login fails on Safari (TC_001, REQ_001)', required: false },
        ]}
      />
    </div>
  )
