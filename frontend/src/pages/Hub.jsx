...
const phaseSections = [
  {
    ...
    tiles: [
      ...
      { path: '/smoke',          icon: '💨', title: 'Smoke Test Plan - Checklist',    desc: 'Post-release build validation',                      gradient: 'from-orange-400 to-toon-yellow', shadow: 'shadow-toon-yellow' },
      { path: '/regression',     icon: '🔄', title: 'Regression Test Plan - Checklist',      desc: 'Change impact analysis',                             gradient: 'from-toon-navy to-blue-700',    shadow: 'shadow-toon' },
